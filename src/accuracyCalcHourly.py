...
hourly_accuracy_df.to_csv('Data/FinalData/Hourly_AQI_Accuracy.csv', index=False)

print("Hourly accuracy data saved to 'Data/FinalData/Hourly_AQI_Accuracy.csv'.")
